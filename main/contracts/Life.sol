...
import "./IManageLifeInvestorsNFT.sol";
...
contract Life is ERC20, Ownable, Pausable {
    ...
    IManageLifeInvestorsNFT private _investorsNft;
    ...
    event StakingClaimed(address indexed claimaint, uint256 rewards);
    ...
    function setNftiToken(
        ...
        _investorsNft = IManageLifeInvestorsNFT(investorsNft_);
    }
